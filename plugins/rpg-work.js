...
global.work = ["Repartiste folletos de eventos en PapuCity y ganaste", "Trabajaste como domador de esclavos negros y por eso ganaste", "Creaste un videojuego estúpido pero aún así ganaste", "Trabajas como cortador de galletas y ganas", "Cuidaste el grupo cuando los admins no estaban por eso ganas", "Trabajas para una empresa militar privada, ganando", "Organiza un evento de cata de vinos y obtiene", "Moderaste el grupo cuando KATASHI FUKUSHIMA no estaba, el pago fue", "iba caminando por la calle y que encuentra con", "ayudaste con el grupo mientras los admins no estaba el pago fue", "Te secuestran y te llevan a un coliseo subterraneo donde luchaste contra monstruos con personas que nunca antes habias conocido. Ganas", "Limpias la chimenea y encuentras", "Desarrollas juegos para ganarte la vida y ganas", "Por que este comando se llama trabajo? Ni siquiera estas haciendo nada relacionado con el trabajo. Sin embargo, ganas", "Trabajaste en la oficina horas extras por", "Trabajas como secuestrador de novias y ganas", "Alguien vino y representa una obra de teatro. Por mirar te dieron", "Compraste y vendiste articulos y Ganaste", "Trabajas en el restaurante de la abuela como cocinera y ganas", "Trabajas 10 minutos en un Pizza Hut local. Ganaste", "Trabajas como escritor(a) de galletas de la fortuna y ganas", "Ves a alguien luchando por subir una caja a su auto, te apresuras a ayudarlo antes de que se lastime. Despues de ayudarlos, amablemente te dan", "Desarrollas juegos para ganarte la vida y ganas", "Ganas un concurso de comer chili picante. El premio es", "Trabajas todo el dia en la empresa por", "Ayudas a moderar el grupo de Katashi Fukushima por", "Diseñaste un logo para iZi por", "Moderaste el grupo cuando Katashi Fukushima no estaba, el pago fue", "Trabajaste lo mejor que pudiste en una imprenta que estaba contratando y ganas un bien merecido!", "Trabajas como podador de arbustos para Martin y ganas", "La demanda de juegos para dispositivos moviles ha aumentado, por lo que creas un nuevo juego lleno de micro-transacciones. Con tu nuevo juego ganas un total de", "Trabajas como actor de voz para Bob Esponja y te las arreglaste para ganar", "Estabas cultivando y Ganaste", "Trabajas como constructor de castillos de arena y ganas", "Trabajaste y Ganaste", "Trabajas como artista callejera y ganas","Hiciste trabajo social por una buena causa! por tu buena causa Recibiste"
]
