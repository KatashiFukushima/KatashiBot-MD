...
//if (ruleta === 'text3') return conn.groupParticipantsUpdate(m.chat, [m.sender], 'demote').catch(m.reply(`😹 _*ESTAS RE MALA QUE QUITÓ EL PODER, AHORA YA NO ERES ADMIN, JODETE*_ 😹😹😹`)) 
//if (ruleta === 'text4') return conn.groupParticipantsUpdate(m.chat, [m.sender], 'promote').catch(m.reply(`😼 _*ESTA RE BUENA 😉, AHORA eres ADMINISTRADOR, EL QUE QUITE ADMIN ES FAN DE KUNNO*_ 😂`)) 
