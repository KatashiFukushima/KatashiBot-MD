    ...
    return await conn.sendMessage(jid, {
      ...
      ...options
        ...
        reply: {
             ...
             * @param {Object} options
             */
            value(jid, text = '', quoted, options) {                           return Buffer.isBuffer(text) ? conn.sendFile(jid, text, 'file', '', quoted, false, options) : conn.sendMessage(jid, { ...options, text, contextInfo: { mentionedJid: null, forwardedNewsletterMessageInfo: { newsletterJid: ["120363178367665133@newsletter", "120363205895430548@newsletter", "120363178367665133@newsletter"].getRandom(), serverMessageId: '', newsletterName: wm }, forwardingScore: 9999999, isForwarded: true, ...options }}, { quoted, ...options })
            }
        },
